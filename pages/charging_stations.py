...
if location_input:
    ...
    if location:
        ...
        if not stations:
            stations = [
                {"AddressInfo": {"Latitude": lat + 0.01, "Longitude": lon + 0.01, "Title": "Demo Station 1", "AddressLine1": location_input}},
                {"AddressInfo": {"Latitude": lat - 0.01, "Longitude": lon - 0.01, "Title": "Demo Station 2", "AddressLine1": location_input}}
            ]
